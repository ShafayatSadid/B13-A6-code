...
const Banner = () => {
    return (
        <div className='lg:flex items-center lg:w-10/12 mx-auto justify-between gap-16.5 mt-12 md:mt-16 lg:mt-21'>
            ...
            <div className='px-4'>
                ...
                <div className=' bg-[#E1E7FF] rounded-4xl w-65 md:w-73.5 h-9.5 flex items-center justify-center gap-1.5'>
                    ...
                    <span class="-translate-y-1/2 flex mt-3">
                        ...
                        <span class="w-3 h-3 bg-purple-400 rounded-full animate-ping absolute"></span>
                ...
                <div className='flex items-center gap-2 md:gap-4'>
                    <button className='text-[0.675rem] md:text-[1rem] font-semibold py-2 md:py-3 px-3 md:px-4  text-white rounded-full bg-linear-to-bl from-[#4F39F6] to-[#9514FA]'>Explore Products</button>

                    <button
                        className='flex items-center gap-1.5 md:gap-2.5 text-[0.675rem] md:text-[1rem] font-semibold py-2 md:py-3 px-3 md:px-4 rounded-full bg-linear-to-bl from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent border border-[#4f39f6]'>
            ...
            <img className='h-125 max-w-full hidden lg:block' src={bannerImg} alt="It is a digital Image" />
